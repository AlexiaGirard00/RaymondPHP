    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" aria-label="">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li>
                            <a href="gestionProduitsActifs.php">Produits Actifs</a>
                        </li>
                        <li>
                            <a href="gestionProduitsAnterieures.php">Produits Antérieures</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="gestionCategories.php">Gestion des catégories</a>      
                </li>
            </ul>
            ...
            <ul class="list-unstyled CTAs">
                ...
                <li>
                    <a href="config/deconnection.php" class="download">Se déconnecter</a>
                </li>
            </ul>
