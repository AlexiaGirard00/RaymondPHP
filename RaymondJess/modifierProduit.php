...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //Valider l'image
    $input_image = $trim($_POST["ImageChemin"]);
    ...
    if (empty($nom_err) && empty($desc_err) && empty($dim_err) && empty($typeBois_err) && empty($prix_err) && empty($prix_err) && empty($image_err)) {
        $sql = "UPDATE `dbo.produits` SET $NomProduit , $IdCategorieFK , $DescriptionProduit , $DimensionProduit, $TypeDeBoisProduit, $CapaciteProduit, $PrixProduit, $ImageChemin, $EstAnterieure, $ActifProduit WHERE IdProduit = $id ";
        ...
        if ($stmt = $connect->prepare($sql)) {
            ...
            if ($stmt->execute()) {
               // header("location: admin.php");
                ...
                echo "Un problème est survenuuuuuuu";
            }
        }
    }
        ...
        if ($stmt = $pdo->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                if ($stmt->rowCount() == 1) {
                    ...
                    $EstAnterieur = $row["EstAnterieure"];
                } else {
    ...
    <div class="container my-5">
        ...
        <form action="<?php echo htmlspecialchars(($_SERVER["PHP_SELF"])); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="file" name="upload_image" class="form-control" value="<?php echo $ImageChemin; ?>" required>
                <img src="uploads/thump_1682289327.jpg" alt="image" class="mt-3 mb-3"></img>
                <input disabled type="text" class="form-control <?php echo (!empty($image_err)) ? "is-invalid" : ""; ?>" id="ImageChemin" name="ImageChemin" value="<?php echo $ImageChemin; ?>">
            </div>
            ...
            <div class="form-group form-check">
                <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="anterieure" <?php echo ($EstAnterieur == 1) ? "checked" : ""; ?>>
...
<?php
        ...
        ?>
            ...
            <div class="row">
                ...
                <!-- <div class="col-md-8">
                        <img class="img-rounded img-responsive" alt="" src="<?php echo $uploadPath . $resizeFileName . '.' . $fileExt; ?>">
